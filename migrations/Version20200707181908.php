 ...
 */
final class Version20200707181908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE etudiant ADD chambre_id INT DEFAULT NULL, ADD type_bourse VARCHAR(255) DEFAULT NULL, ADD adresse VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE etudiant DROP chambre_id, DROP type_bourse, DROP adresse');
    }
}
